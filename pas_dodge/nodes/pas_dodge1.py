...
Pub_target_goal = rospy.Publisher('target_goal', PoseStamped, queue_size=5)
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        Ref_marker.pose.position.z = Ref_yaw
        Goal_des.pose.position.x = Ref_x
        Goal_des.pose.position.y = Ref_y
        Goal_des.pose.position.z = Ref_yaw  # need to adjust accordingly
        Pub_ref_marker.publish(Ref_marker)
        Pub_target_goal.publish(Goal_des)
